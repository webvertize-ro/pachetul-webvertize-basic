  ...
  return (
    <StyledGoogleMapsSection>
      <div className="container d-flex flex-column gap-2">
        ...
        <StyledP>
          Suntem un business local, cu sediu fizic, ușor de accesat. Indiferent
          dacă vrei să ne vizitezi sau doar să știi exact unde ne aflăm, locația
          noastră este afișată mai jos.
        </StyledP>
        <StyledIframe
